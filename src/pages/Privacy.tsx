...
export function Privacy() {
  useEffect(() => {
    updateSEO({ title: 'Privacy Policy', description: 'Read the Kinoma Privacy Policy.', canonicalUrl: window.location.origin + '/privacy', type: 'website' });
  }, []);
  ...
  return (
    <main className="kinoma-simple-page">
      <article className="kinoma-simple-page__document">
        ...
        <p>Kinoma is designed to keep the experience focused. This page will contain the complete privacy notice as the account and MovieApi systems are finalised.</p>

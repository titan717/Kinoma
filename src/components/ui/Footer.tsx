        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-8">
          <div className="flex flex-col gap-6 max-w-md">
            <div className="flex items-center gap-0.5 select-none">
              <span className="text-3xl font-black tracking-tighter text-white">ani</span>
              <span className="text-3xl font-black tracking-tighter text-[#4c1d95]">mora</span>
            </div>
            
            <div className="text-xs text-gray-500 font-medium leading-relaxed flex flex-col gap-1">
              <p>Copyright © Animora.ru. All Rights Reserved</p>

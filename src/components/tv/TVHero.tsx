...
export function TVHero({
  ...
  return (
    <div className="relative w-full h-[68vh] min-h-[500px] max-h-[720px] overflow-hidden select-none">
      ...
      <div className="absolute inset-0">
        <img
          ...
          className="w-full h-full object-cover object-center filter brightness-[0.92] contrast-[1.08] transition-transform duration-700 ease-out scale-[1.02]"
        />
